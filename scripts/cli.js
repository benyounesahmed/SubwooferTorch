...
const contractABI = require("../artifacts/contracts/Subwoofertorch.sol/Subwoofertorch.json").abi;

program
    .name("subwoofertorch-cli")
    .description("CLI tool for Subwoofertorch smart contract")
    .version("1.0.0");
